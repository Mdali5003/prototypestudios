  ...
  return (
    <section ref={sectionRef} className="relative h-[70vh] md:h-[85vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-30 text-center px-6 max-w-5xl mx-auto">
        ...
        <h1
          className={`font-brand text-[clamp(3rem,10vw,9rem)] leading-[1] tracking-[0.12em] text-foreground transition-all duration-[1400ms] delay-200 ease-[cubic-bezier(0.16,1,0.3,1)] ${
