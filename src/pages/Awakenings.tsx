...
const clips: Clip[] = [
  { id: 1, src: "/awakenings/awakenings-1.mp4", title: "AWAKENINGS 1", vertical: true },
  { id: 2, src: "/awakenings/awakenings-2.mp4", title: "AWAKENINGS 2" },
  { id: 3, src: "/awakenings/awakenings-3.mp4", title: "AWAKENINGS 3" },
  { id: 4, src: "/awakenings/awakenings-4.mp4", title: "AWAKENINGS 4" },
  { id: 5, src: "/awakenings/awakenings-5.mp4", title: "AWAKENINGS 5" },
];
...
const ClipCard = ({ clip, onOpen }: { clip: Clip; onOpen: () => void }) => {
  ...
  return (
    <div
      ...
      className={`relative overflow-hidden cursor-pointer ${clip.vertical ? "aspect-[9/16]" : "aspect-video"}`}
    >
      <video
        autoPlay
        muted
