...
const projectData: Record<string, { title: string; subtitle: string; media: MediaItem[]; vertical?: boolean }> = {
  ...
  "short-form": {
    ...
    media: [
      ...
      { id: 2, src: "/portfolio/short-form-7.mp4", title: "SHORT FORM 02", type: "video", vertical: true },
      { id: 3, src: "/portfolio/short-form-4.mp4", title: "SHORT FORM 03", type: "video", vertical: true },
      { id: 4, src: "/portfolio/short-form-9.mp4", title: "SHORT FORM 04", type: "video", vertical: true },
      { id: 5, src: "/portfolio/short-form-5.mp4", title: "SHORT FORM 05", type: "video", vertical: true },
      { id: 6, src: "/portfolio/short-form-2.mp4", title: "SHORT FORM 06", type: "video", vertical: true },
      { id: 7, src: "/portfolio/short-form-3.mp4", title: "SHORT FORM 07", type: "video", vertical: true },
      { id: 8, src: "/portfolio/short-form.mp4", title: "SHORT FORM 08", type: "video", vertical: true },
      { id: 9, src: "/portfolio/short-form-8.mp4", title: "SHORT FORM 09", type: "video", vertical: true },
    ],
    ],
  },
  photos: {
