...
const projectData: Record<string, { title: string; subtitle: string; media: MediaItem[]; vertical?: boolean }> = {
  ...
  "short-form": {
    ...
    media: [
      { id: 1, src: "/portfolio/sf-francis.mp4", title: "FRANCIS", type: "video", vertical: true, link: "https://youtube.com/shorts/F5yYFcMilps" },
      { id: 2, src: "/portfolio/sf-hilde.mp4", title: "HILDE", type: "video", vertical: true, link: "https://youtube.com/shorts/xp1y_0iUsEg" },
      { id: 3, src: "/portfolio/sf-ga.mp4", title: "G&A", type: "video", vertical: true, link: "https://youtube.com/shorts/6cQZ8Kv37BA" },
      { id: 4, src: "/portfolio/sf-ona-missrich.mp4", title: "ONA & MISS RICH", type: "video", vertical: true, link: "https://youtube.com/shorts/W3MvLgvVetk" },
      { id: 5, src: "/portfolio/sf-livak.mp4", title: "LIVA K", type: "video", vertical: true, link: "https://youtube.com/shorts/5o9lzV8E0OM" },
      { id: 6, src: "/portfolio/sf-arcadian.mp4", title: "ARCADIAN", type: "video", vertical: true, link: "https://youtube.com/shorts/s7mqKS1ESO8" },
      { id: 7, src: "/portfolio/sf-honeyluv.mp4", title: "HONEYLUV", type: "video", vertical: true, link: "https://youtube.com/shorts/tkuufatEbbs" },
      { id: 8, src: "/portfolio/sf-amelie.mp4", title: "AMELIE", type: "video", vertical: true, link: "https://youtube.com/shorts/aWvZgHhgVEk" },
      { id: 9, src: "/portfolio/sf-reel22.mp4", title: "REEL", type: "video", vertical: true, link: "https://youtube.com/shorts/bzS40TEeb0M" },
      { id: 10, src: "/portfolio/sf-moblack.mp4", title: "MOBLACK", type: "video", vertical: true, link: "https://youtube.com/shorts/dYY4xaksB0M" },
    ],
  },
  photos: {
    title: "PHOTOS",
